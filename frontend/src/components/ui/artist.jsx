        ...
        <style>{`
          *{box-sizing:border-box;margin:0;padding:0}
          ...
          @media(max-width:480px){
            ...
            .qa-song-row .song-duration{display:none}
          }
          ...
          <div style={{ flex: 1, display: "flex", overflow: "hidden", minWidth: 0 }}>
            <div style={{ flex: 1, overflowY: "auto", position: "relative", display: "flex", flexDirection: "column" }}>
              ...
              <div style={{ position: "relative", height: 380, overflow: "hidden", flexShrink: 0 }}>
                ...
                {/* ── Artist portrait card — top-left ── */}
                <div className="hero-artist-portrait">
                  <div className="hero-artist-portrait-img">
                    <img
                      src={artistImg}
                      alt={decodedName}
                      onError={e => { e.target.src = dicebearUrl(decodedName) }}
                    />
                  </div>
                  <div className="hero-artist-portrait-label">{decodedName}</div>
                </div>

                {/* Hero content — text & buttons (shifted right to avoid portrait overlap) */}
                <div
                ...
                >
                  ...
                  <h1
                    ...
                    style={{
                      fontSize: "clamp(28px,4.5vw,72px)", fontWeight: 900, color: "#fff",
